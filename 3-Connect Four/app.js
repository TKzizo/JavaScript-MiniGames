document.addEventListener('DOMContentLoaded', () => {
    ...
    for(var i = 0 , len = squares.length ; i < len ; i++){
        ...
        //onclick for each element (func(param..){ body,,,,} ) (i)
        (function (index){
        ...
        function checkboard(){
            const winningarrays =  [[0, 1, 2, 3], [41, 40, 39, 38], [7, 8, 9, 10], [34, 33, 32, 31], [14, 15, 16, 17], [27, 26, 25, 24], [21, 22, 23, 24],
            ...
            for ( y = 0 ; y < winningarrays.length ; y++ ){
